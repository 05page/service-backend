...
<head>
    ...
    <style>
        * {
        ...
        /* Nouveau style pour le lien cliquable */
        .activation-link {
        ...
        .activation-link:hover .activation-code {
        ...
        /* Effet de clic */
        .activation-link:active .activation-code {
            transform: scale(0.98);
        }
        
        /* Animation de pulse subtile pour indiquer que c'est cliquable */
        .activation-code::after {
            content: '';
            position: absolute;
            top: 0;
            left: 0;
